...
public class UserService {
    ...
    public UserDto getUserByuserNo(String userNo) {
        ...
        //String externalApiUrl = "http://k8s-edu-goods-service.edu-goods.svc.cluster.local:80/api/v1/goods/" + userNo;
        ...
        System.out.println("External(goods)-----Response: " + externalResponse);
